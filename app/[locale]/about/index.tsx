    ...
    <MainLayout>
      ...
      <div className={classNames('flex justify-center items-start rounded-xl w-30', styles["aboutMainPhoto"])} />
        <div className={classNames('flex flex-column justify-center items-start', styles["aboutText"])}>
          ...
          {"ТОВ «ДМ-ПРОЕКТ» засноване у 2009 році. Ми є офіційним представником в Україні міжнародної компанії Dräger, світового лідера у виробництві систем життєзабезпечення людини.Наше медичне обладнання успішно використовується у багатьох лікувальних закладах країни. Так ми поставили понад 1000 апаратів штучної вентиляції легень, що надійно працюють у всіх областях України."}</div>
          <div className={classNames('m-2 indent-5 text-justify')}>
