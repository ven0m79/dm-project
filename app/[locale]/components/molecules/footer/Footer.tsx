    ...
    >
      <div className={styles.footerContainer}>
        ...
        <div className={classNames('font-bold', styles["column"])}>
          ...
          <Link href="/catalog/sub-catalog?category=icu-equipment"><div className={classNames('font-normal mt-1 ml-5 hover:text-green-600')}>{t('icu-equipment')}</div></Link>
          <Link href="/catalog/sub-catalog?category=neonatal-equipment"><div className={classNames('font-normal mt-1 ml-5 hover:text-green-600')}>{t('neonatal-equipment')}</div></Link>
          <Link href="/catalog/sub-catalog?category=cleaning-and-desinfecting-equipment"><div className={classNames('font-normal mt-1 ml-5 hover:text-green-600')}>{t('candd-equipment')}</div></Link>
          <Link href={{
