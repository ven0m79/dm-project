...
const customTheme: CustomFlowbiteTheme = {
  sidebar: {
    ...
    collapse: {
      button:
        "group flex w-full items-center rounded-lg p-1 text-base font-normal text-[#0061AA] transition duration-75 hover:bg-[#0061aa10]",
      icon: {
    ...
    item: {
      ...
      active: "text-red-500 bg-gray-100",
      collapsed: {
