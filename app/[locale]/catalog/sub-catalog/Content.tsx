// app/[locale]/catalog/sub-catalog/Content.tsx
"use client";
    ...
    <div className={classNames("flex flex-1 flex-row justify-between self-center mb-5 mt-5 mx-2", styles.subCatalog)}>
      ...
      {typeof window !== "undefined" && isMobile ? (
        <>
          ...
          >
            <button className="absolute top-7 right-3 text-xl text-slate-800 font-bold text-[30px]" onClick={() => setIsLeftSidebarOpen(false)}>
              ✕
            </button>
            <div className="p-4">
      ...
      {typeof window !== "undefined" && isMobile ? (
        <>
          ...
          <motion.div
            ...
            className="fixed top-0 left-0 w-full h-full bg-white/50 backdrop-blur-sm shadow-lg z-50 cursor-grab active:cursor-grabbing overflow-y-auto"
          >
            <button className="absolute top-4 right-4 text-xl text-slate-800" onClick={() => setIsRightSidebarOpen(false)}>
              ✕
            </button>
            <div className="p-4">
