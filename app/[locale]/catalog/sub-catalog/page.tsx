...
//       `https://api.dm-project.com.ua/wp-json/wc/v3/products/categories?slug=${slug}&lang=${locale}&consumer_key=${process.env.WC_CONSUMER_KEY}&consumer_secret=${process.env.WC_CONSUMER_SECRET}`,
//       { cache: "no-store" }
//     ).then((res) => res.json());
