...
const CatalogPage = ({ params: { locale } }: { params: { locale: string } }) => {
  ...
  return (
    <MainLayout>
      <Suspense fallback="Loading..."> {/* Ensuring Suspense is correctly applied */}
        <div className={classNames("text-2xl flex flex-wrap justify-start mb-5 gap-5 mt-5", styles.catalogContainer)}>
          <Link
            href={{
          ...
          >
            <div className={classNames("flex flex-row items-center rounded-xl", styles["block-decisions"])}>
