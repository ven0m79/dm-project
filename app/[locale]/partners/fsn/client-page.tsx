        ...
        <MainLayout>
            <div className="flex flex-col justify-center items-center w-full max-w-250 pb-3 px-2">
                ...
                <div className="flex shrink-0 sm:flex-row flex-col w-full">
                    ...
                    <div className="text-[#0061AA] w-full indent-0 sm:indent-5 leading-relaxed text-justify self-center">
                        ...
                        <div className="text-[16px] sm:text-[20px]">
                            <strong className="text-[#002766]">Рік заснування:</strong> 2000
                        </div>
                        <div className="text-[16px] sm:text-[20px]">
                            <strong className="text-[#002766]">Країна:</strong> США (Anaheim, California)
                        </div>
                        <div className="text-[16px] sm:text-[20px]">
                            <strong className="text-[#002766]">Офіційний сайт: </strong>
                            <Link href="https://fsnmed.com/" target="_blank">
                                https://fsnmed.com/
                            </Link>
                        </div>
                        <div className="text-[18px] sm:text-[20px]">
                            ...
                            <div className="flex flex-row pl-10 pt-2 gap-4">
                                <Link
                                    href="https://www.linkedin.com/company/fsn-medical-technologies/"
                                    target="_blank"
                                >
                                    <Image
                                        src="/linkedin.webp"
                                ...
                                <Link href="https://www.youtube.com/channel/UCIKzikhfCrtUkFIglCOGFCA" target="_blank">
                                    <Image
                                        src="/youtube-ico.jpg"
                                        width={30}
                                        height={30}
                                ...
                                <Link
                                    href="https://www.facebook.com/p/FSN-Medical-Technologies-100057404622462/"
                                    target="_blank"
                                >
                                    <Image
                                ...
                                <Link
                                    href="https://www.instagram.com/fsnmedicaltechnologies/"
                                    target="_blank"
                                >
                                    <Image
                                        src="/instagram.webp"
                ...
                <div className="text-[#0061AA] w-full indent-5 leading-relaxed text-justify pt-4">
                    FSN Medical Technologies — виробник рішень для відображення, передавання та керування відеосигналом у медичних процедурних зонах. Основний фокус бренду — хірургічні медичні монітори та системи відеоінтеграції, створені під вимоги операційної: стабільність сигналу, сумісність із обладнанням і надійна робота в режимі реального часу.
                </div>
                {/* PAGINATION + PRODUCTS */}
