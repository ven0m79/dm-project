      ...
      >
        ...
        >
          <p className=" text-justify text-[24px]">
            {t("shares-atlan300-title")}
          </p>
          <p className="text-justify">
            {t("shares-atlan300-pehead")}{" "}
            <span className="font-bold">51 700,00 у.о.</span>
          </p>
        ...
        <div
          className={classNames(
            "self-center my-2 indent-5 text-justify",
