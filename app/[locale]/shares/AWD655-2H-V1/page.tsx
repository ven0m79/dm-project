        ...
        <MainLayout>
            ...
            >
                <div className={classNames(
                    ...
                    <p className=" text-centered text-[24px]">{t('shares-awd655-h2-v1-title')}</p>
                    ...
                    <div className="flex flex-row">
                        <div className="flex flex-row w-[1050px]">
                            ...
                            <div className="pl-10 w-[525px]">
                                -	{t('shares-awd655-h2-v1-specific1')}<br />
                                -	{t('shares-awd655-h2-v1-specific2')}<br />
                                -	{t('shares-awd655-h2-v1-specific3')}<br />
                                -	{t('shares-awd655-h2-v1-specific4')}<br />
                                -	{t('shares-awd655-h2-v1-specific5')}<br />
                                -	{t('shares-awd655-h2-v1-specific6')}<br />
                                -	{t('shares-awd655-h2-v1-specific7')}<br />
                                -	{t('shares-awd655-h2-v1-specific8')}<br />
                                -	{t('shares-awd655-h2-v1-specific9')}<br />
                                -	{t('shares-awd655-h2-v1-specific10')}<br />
                                -	{t('shares-awd655-h2-v1-specific11')}<br />
                            </div>
                        </div>
                    </div>
                </div>
